<template>
  <el-container id="container">
    <el-aside width="250px">
      <el-container id="top">
        <!-- <img stype="width:25px;height:25px;margin:auto;margin-right:0" src="~@/assets/logo.png"> -->
        <div stype="margin:auto;margin-left:10px;color:#ffffff;font-size:17">电商后台管理</div>
      </el-container>
      <el-menu
    ...
    <el-main stype="padding:0">
      ...
      <el-header style="margin:0;padding:0;" height="80px">
        <el-container style="background-color:blanchedalmond;margin:0;padding:0;height:80px">
          ...
          <div style="margin:auto;margin-right:50">
