...
func main() {
	...
	PrintSalary((*Employee)(unsafe.Pointer(worker)))
	PrintSalary((*Employee)(unsafe.Pointer(farmer)))
	PrintSalary((*Employee)(unsafe.Pointer(teacher)))
	PrintSalary((*Employee)(unsafe.Pointer(scientist)))
	PrintSalary((*Employee)(unsafe.Pointer(waiter)))
}
