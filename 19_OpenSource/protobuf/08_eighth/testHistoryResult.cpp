...
int main(int argc, char* argv[])
{
    ...
    // the first group
    {
        ...
        hr.mutable_dic()->insert(google::protobuf::MapPair<int32_t, mam::AccountOverviews>(200, aos));
    }
    // the second group
    {
        mam::AccountOverviews aos;
        ...
        hr.mutable_dic()->insert(google::protobuf::MapPair<int32_t, mam::AccountOverviews>(300, aos));
    }
    // the third group
    {
        mam::AccountOverviews aos;
        ...
        hr.mutable_dic()->insert(google::protobuf::MapPair<int32_t, mam::AccountOverviews>(100, aos));
    }

    serialize_callback(hr);
