...
```sh
    ...
    [2021-10-23 10:38:09,129: ERROR/ForkPoolWorker-2] Task airflow.executors.celery_executor.execute_command[edd7d8df-91a9-46f5-82a1-ffa3095a90f5] raised unexpected: AirflowException('Celery command failed on host: jingle-231')
    Traceback (most recent call last):
```
...
[Chart: Create a random secret for Webserver's flask secret key](https://github.com/apache/airflow/pull/17142)